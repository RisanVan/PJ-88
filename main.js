...
function new_image()
{
	abric.Image.fromURL("ball.png", function(Img){
    ball_obj = Img;
    ball_obj_obj.scaleToWidth(50);
    ball_obj_obj.scaleToHeight(50);
    ball_obj_obj.set({
        top:ball_y,
        left:ball_x
    })
        canvas.add(ball_obj_obj);
    })
}
...
function my_keydown(e)
{
	...
	if((ball_x==hole_x)&&(ball_y==hole_y)){
        ...
        document.getElementById("hd3").innerHTML="You you have hit the Goal!!!";
